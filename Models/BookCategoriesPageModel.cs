...
namespace Cristache_Ana_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cristache_Ana_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cristache_Ana_Lab2Context context,
